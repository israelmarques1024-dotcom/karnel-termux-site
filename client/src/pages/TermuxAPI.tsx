...
const commands = {
  ...
  location: [{ desc: "Get GPS location", cmd: "termux-location" }],
  notifications: [
    {
        ...
        <AnimatedSection delay={100}>
          <div className="card-hover bg-card border border-accent/50 rounded-lg p-6 mb-12">
            ...
            <p className="text-sm text-muted-foreground mb-4">
              Install the APK and termux-api package, then run any command
              below.
            </p>
            <CodeBlock
              ...
              <AnimatedSection delay={250}>
                <div className="space-y-4">
                  {cmds.map((item, i) => (
                    <div
                      key={i}
                      className="card-hover bg-card border border-border rounded-lg p-4"
                    >
        ...
        <AnimatedSection delay={300}>
          <div className="card-hover bg-card border border-border rounded-xl p-8">
            ...
            <div className="space-y-6">
              ...
              <div>
                <h3 className="font-bold font-mono mb-3">
