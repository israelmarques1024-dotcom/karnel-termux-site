  ...
  return (
    <section className="py-12 px-4">
      <div className="max-w-4xl mx-auto">
        <AnimatedSection>
          <h1 className="text-4xl font-bold font-mono mb-4">Global npm Packages</h1>
        ...
        <AnimatedSection delay={100}>
          <div className="card-hover bg-card border border-accent/50 rounded-lg p-6 mb-12">
            ...
            <p className="text-sm text-muted-foreground mt-2">
              Install specific: <code className="text-accent">karnel install npm --typescript --prettier</code>
            </p>
          </div>
        </AnimatedSection>

        <AnimatedSection delay={200}>
          <h2 className="text-2xl font-bold font-mono mb-6">Available Packages</h2>
        </AnimatedSection>
          ...
          {packages.map((pkg, i) => (
            <AnimatedSection key={i} delay={300 + i * 50}>
              <div className="card-hover bg-card border border-border rounded-lg p-6">
                ...
                <p className="text-xs text-muted-foreground mb-3">Command: <code className="text-accent">{pkg.bin}</code></p>
