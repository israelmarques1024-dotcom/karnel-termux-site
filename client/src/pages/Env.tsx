...
karnel env export               # Exporta tudo pro shell atual`}
          ...
          <div className="space-y-6 mb-12">
            {[
              { code: "karnel env set OPENAI_API_KEY sk-...", desc: "Salva sua chave da OpenAI com segurança." },
              { code: "karnel env get OPENAI_API_KEY", desc: "Recupera a chave quando precisar." },
              { code: "karnel env export", desc: "Exporta tudo pro ambiente atual." },
            ].map((ex, i) => (
          ...
          <AnimatedSection delay={500}>
            ...
            <div className="card-hover bg-card border border-border rounded-lg p-6">
              ...
              <p className="text-muted-foreground">
                Use <code className="text-accent">karnel env export</code> no seu <code className="text-accent">~/.zshrc</code>
