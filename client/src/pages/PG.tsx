  ...
  return (
      <section className="py-12 px-4">
        <div className="max-w-4xl mx-auto">
          <AnimatedSection>
            <h1 className="text-4xl font-bold font-mono mb-4">karnel pg — PostgreSQL Manager</h1>
            <p className="text-lg text-muted-foreground mb-8">
              Manage PostgreSQL databases directly from the terminal: start, stop, create,
              drop, and enter the psql shell with one command.
            </p>
          </AnimatedSection>
          ...
          <AnimatedSection delay={200}>
            ...
            <div className="card-hover bg-card border border-border rounded-lg p-6 mb-12">
              ...
              <p className="text-sm text-muted-foreground mt-3">
                 Initializes PostgreSQL, starts the server, and creates a database called "myapp".
              </p>
            </div>
          </AnimatedSection>
