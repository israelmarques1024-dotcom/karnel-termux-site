...
const examples = [
  {
    ...
    desc: "Show OpenCode README in AI module",
  },
  ...
  {
    cmd: "karnel show npm --typescript",
    desc: "Show TypeScript npm package guide",
  },
  {
...
const modules = [
  ...
  {
    mod: "lang",
    cmd: "karnel show lang --nodejs",
    tools: "nodejs, python, rust, golang",
  },
  {
    mod: "db",
    cmd: "karnel show db --postgresql",
    tools: "postgresql, mariadb, sqlite, mongodb, redis",
  },
  { mod: "dev", cmd: "karnel show dev --gh", tools: "gh, wget, curl, fzf" },
  {
    mod: "npm",
    cmd: "karnel show npm --typescript",
    tools: "typescript, nestjs, prettier",
  },
  {
    mod: "shell",
    cmd: "karnel show shell --powerlevel10k",
    tools: "powerlevel10k, zsh-syntax-highlighting",
  },
  {
    mod: "editor",
    cmd: "karnel show editor --code-server",
    tools: "code-server",
  },
  {
    mod: "deploy",
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <AnimatedSection delay={100}>
          <div className="card-hover bg-card border border-accent/50 rounded-lg p-6 mb-12">
            ...
            <CodeBlock
              code={"karnel show <module> --<tool>"}
              language="bash"
              title="terminal"
            />
            <p className="text-sm text-muted-foreground mt-4">
              Run{" "}
              <code className="text-accent">karnel list &lt;module&gt;</code>{" "}
              first to see available tools in a module.
            </p>
          </div>
        </AnimatedSection>
          ...
          <div className="card-hover bg-card border border-border rounded-lg p-6 mb-12">
            <p className="text-muted-foreground mb-6">
              ...
              <code className="text-accent">
                $KARNEL_PATH/tools/&lt;module&gt;/&lt;tool&gt;/README.md
              </code>
              e o exibe. Se o <code className="text-accent">glow</code> estiver
              instalado, ele renderiza com destaque de sintaxe. Caso contrário,
              usa pygmentize ou cat simples.
            </p>
        ...
        <AnimatedSection delay={850}>
          <div className="card-hover bg-card border border-border rounded-lg p-6 mb-12">
            <p className="text-muted-foreground mb-4">
              Execute{" "}
              <code className="text-accent">karnel show &lt;module&gt;</code>{" "}
              sem uma flag de ferramenta para listar todas as ferramentas
...
gemini            Google Gemini CLI`}
            ...
            />
            <p className="text-sm text-muted-foreground mt-4">
              A primeira linha do README de cada ferramenta é mostrada como sua
              descrição.
            </p>
          </div>
        </AnimatedSection>
