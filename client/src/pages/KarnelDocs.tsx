        ...
        <AnimatedSection delay={100}>
          <div className="card-hover bg-card border border-accent/50 rounded-lg p-6 mb-12">
            ...
            <div className="space-y-3">
              <CodeBlock
                code={`curl -fLO https://github.com/israelmarques1024-dotcom/karnel-termux/releases/download/v4.17.43/karnel-termux-install.sh
curl -fLO https://github.com/israelmarques1024-dotcom/karnel-termux/releases/download/v4.17.43/karnel-termux-install.sh.sha256
sha256sum -c karnel-termux-install.sh.sha256
bash karnel-termux-install.sh --ref v4.17.43`}
                language="bash"
                title="quick install"
              />
